...
public class ProductShoppingListActivity extends AppCompatActivity implements ProductShoppingListAdapter.OnCardListener {
    ...
    private CollectionReference collectionReference = db.collection(productDBInfo.getCollectionName());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ProductShoppingListAdapter(this, products, this);
